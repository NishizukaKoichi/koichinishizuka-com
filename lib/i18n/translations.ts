...
"product.pact.not_handles": "人格評価、感情的表現、裁量判断",
    ...
    // MagicSpell Product
    "product.magicspell.name": "MagicSpell",
    "product.magicspell.definition": "「この実行は許可されているか」にYes/Noを返す判定装置",
    "product.magicspell.handles": "Scope Check、Entitlement付与/剥奪、Audit Log",
    "product.magicspell.not_handles": "処理の中身、安全性判断、価格設定、カタログ機能",
    ...
    // MagicSpell
    "magicspell.title": "MagicSpell",
    "magicspell.subtitle": "Entitlement & Distribution OS",
    "magicspell.landing.headline": "作ったものを、安心して売る",
    "magicspell.landing.desc1": "MagicSpellは機能を作りません。中身に関知しません。",
    "magicspell.landing.desc2": "扱うのは「権利の付与」と「配布の制御」だけ。",
    "magicspell.landing.desc3": "売り方は、あなたに委ねられます。",
    "magicspell.landing.login_btn": "ログイン",
    "magicspell.landing.start": "商品を登録する",
    "magicspell.landing.consent": "登録することで、上記の原則に同意したものとみなされます",
    "magicspell.landing.problems_title": "課題と解決",
    "magicspell.landing.how_it_works": "仕組み",
    "magicspell.landing.step1_title": "商品を登録",
    "magicspell.landing.step1_desc": "SKU、価格、Scopeを定義",
    "magicspell.landing.step2_title": "Webhookを設定",
    "magicspell.landing.step2_desc": "Stripe Webhookで課金を確定",
    "magicspell.landing.step3_title": "APIで判定",
    "magicspell.landing.step3_desc": "Entitlementを照会して実行制御",
    "magicspell.landing.step4_title": "判定で分岐",
    "magicspell.landing.step4_desc": "YesならOK、Noなら購入へ誘導",
    "magicspell.landing.features_title": "コア機能",
    "magicspell.landing.user_flow_title": "ユーザーフロー",
    "magicspell.landing.cta_desc": "個人開発者・小規模チームのための販売インフラ",
    "magicspell.principle.1.title": "Entitlementが真実点",
    "magicspell.principle.1.desc": "課金状態ではなく、権利の有無が実行可否を決定します。",
    "magicspell.principle.2.title": "Webhook-onlyで確定",
    "magicspell.principle.2.desc": "戻りURLに依存しません。Stripe Webhookのみで課金を確定します。",
    "magicspell.principle.3.title": "Reconcileで復旧可能",
    "magicspell.principle.3.desc": "不整合が発生しても、Reconcile APIで状態を修正できます。",
    "magicspell.principle.4.title": "ScopeでGate",
    "magicspell.principle.4.desc": "実行・ダウンロードの判定はScopeに連動。中身には関知しません。",
    "magicspell.principle.5.title": "Audit / Ledgerで説明可能",
    "magicspell.principle.5.desc": "すべての状態変化は監査可能。責任を説明できます。",
    "magicspell.principle.6.title": "中身には関知しない",
    "magicspell.principle.6.desc": "MagicSpellはアプリの機能を作りません。売る仕組みだけを提供します。",
    "magicspell.dashboard": "ダッシュボード",
    "magicspell.products": "商品",
    "magicspell.entitlements": "Entitlements",
    "magicspell.distribution": "配布",
    "magicspell.audit": "監査",
    "magicspell.settings": "設定",
    "magicspell.products.title": "商品管理",
    "magicspell.products.desc": "SKUと価格を定義",
    "magicspell.products.create": "商品を追加",
    "magicspell.products.empty": "商品がありません",
    "magicspell.products.name": "商品名",
    "magicspell.products.sku": "SKU",
    "magicspell.products.price": "価格",
    "magicspell.products.status": "状態",
    "magicspell.products.active": "有効",
    "magicspell.products.inactive": "無効",
    "magicspell.products.type": "タイプ",
    "magicspell.products.type.one_time": "買い切り",
    "magicspell.products.type.subscription": "サブスクリプション",
    "magicspell.products.stripe_product_id": "Stripe Product ID",
    "magicspell.products.stripe_price_id": "Stripe Price ID",
    "magicspell.entitlements.title": "Entitlements",
    "magicspell.entitlements.desc": "ユーザーごとの権利状態",
    "magicspell.entitlements.search": "ユーザーIDで検索...",
    "magicspell.entitlements.empty": "Entitlementがありません",
    "magicspell.entitlements.user_id": "User ID",
    "magicspell.entitlements.product": "商品",
    "magicspell.entitlements.granted_at": "付与日時",
    "magicspell.entitlements.expires_at": "有効期限",
    "magicspell.entitlements.source": "ソース",
    "magicspell.entitlements.revoke": "剥奪",
    "magicspell.entitlements.grant": "手動付与",
    "magicspell.entitlements.reconcile": "Reconcile",
    "magicspell.distribution.title": "配布管理",
    "magicspell.distribution.desc": "ビルド済み成果物の配布",
    "magicspell.distribution.upload": "ファイルをアップロード",
    "magicspell.distribution.empty": "配布物がありません",
    "magicspell.distribution.file": "ファイル",
    "magicspell.distribution.version": "バージョン",
    "magicspell.distribution.scope": "スコープ",
    "magicspell.distribution.downloads": "DL数",
    "magicspell.distribution.created_at": "作成日時",
    "magicspell.audit.title": "監査ログ",
    "magicspell.audit.desc": "すべての状態変化の記録",
    "magicspell.audit.filter": "フィルター",
    "magicspell.audit.event": "イベント",
    "magicspell.audit.timestamp": "日時",
    "magicspell.audit.actor": "実行者",
    "magicspell.audit.details": "詳細",
    "magicspell.ledger.title": "Ledger",
    "magicspell.ledger.desc": "Stripe Event履歴",
    "magicspell.ledger.event_id": "Event ID",
    "magicspell.ledger.type": "タイプ",
    "magicspell.ledger.processed_at": "処理日時",
    "magicspell.ledger.idempotency": "冪等性",
    "magicspell.settings.title": "設定",
    "magicspell.settings.webhook": "Webhook設定",
    "magicspell.settings.webhook_url": "Webhook URL",
    "magicspell.settings.webhook_secret": "Webhook Secret",
    "magicspell.settings.api_key": "API Key",
    "magicspell.settings.regenerate": "再生成",
    "magicspell.settings.danger_zone": "危険な操作",
    "magicspell.settings.delete_all": "すべてのデータを削除",
    "magicspell.stats.total_products": "商品数",
    "magicspell.stats.active_entitlements": "有効な権利",
    "magicspell.stats.api_calls": "APIコール数",
    "magicspell.stats.webhook_events": "Webhookイベント",
...
"product.pact.not_handles": "Evaluation, Recommendation, Optimization",
    ...
    // MagicSpell Product
    "product.magicspell.name": "MagicSpell",
    "product.magicspell.definition": "A judgment device that returns Yes/No to 'is this execution allowed?'",
    "product.magicspell.handles": "Scope Check, Entitlement grant/revoke, Audit Log",
    "product.magicspell.not_handles": "Processing logic, Safety judgment, Pricing, Catalog features",
  ...
  "talisman.landing.headline": "Observe identity sameness",
    ...
    "magicspell.title": "MagicSpell",
    "magicspell.subtitle": "Entitlement & Distribution OS",
    "magicspell.landing.headline": "Sell what you built, with confidence",
    "magicspell.landing.desc1": "MagicSpell does not build features. Does not handle internals.",
    "magicspell.landing.desc2": "It handles only 'granting rights' and 'controlling distribution'.",
    "magicspell.landing.desc3": "How you sell is up to you.",
    "magicspell.landing.login_btn": "Login",
    "magicspell.landing.start": "Register Product",
    "magicspell.landing.consent": "By registering, you agree to the principles above",
    "magicspell.landing.problems_title": "Problems & Solutions",
    "magicspell.landing.how_it_works": "How It Works",
    "magicspell.landing.step1_title": "Register Product",
    "magicspell.landing.step1_desc": "Define SKU, price, and deliverables",
    "magicspell.landing.step2_title": "Setup Webhook",
    "magicspell.landing.step2_desc": "Confirm payment via Stripe Webhook",
    "magicspell.landing.step3_title": "Query API",
    "magicspell.landing.step3_desc": "Check Entitlement to control execution",
    "magicspell.landing.step4_title": "Allow Distribution",
    "magicspell.landing.step4_desc": "Distribute builds via Download Gate",
    "magicspell.landing.features_title": "Core Features",
    "magicspell.landing.user_flow_title": "User Flow",
    "magicspell.landing.cta_desc": "Sales infrastructure for indie developers and small teams",
    "magicspell.principle.1.title": "Entitlement is the source of truth",
    "magicspell.principle.1.desc": "Execution is determined by rights, not payment status.",
    "magicspell.principle.2.title": "Webhook-only confirmation",
    "magicspell.principle.2.desc": "No reliance on return URLs. Payment confirmed only via Stripe Webhook.",
    "magicspell.principle.3.title": "Reconcile for recovery",
    "magicspell.principle.3.desc": "If inconsistencies occur, state can be fixed via Reconcile API.",
    "magicspell.principle.4.title": "Distribution via Scope + Gate",
    "magicspell.principle.4.desc": "Download permissions are tied to Entitlement. Safely sell ownership.",
    "magicspell.principle.5.title": "Explainable via Audit / Ledger",
    "magicspell.principle.5.desc": "All state changes are auditable. Responsibility can be explained.",
    "magicspell.principle.6.title": "No involvement with internals",
    "magicspell.principle.6.desc": "MagicSpell does not build app features. It only provides the selling mechanism.",
    "magicspell.dashboard": "Dashboard",
    "magicspell.products": "Products",
    "magicspell.entitlements": "Entitlements",
    "magicspell.distribution": "Distribution",
    "magicspell.audit": "Audit",
    "magicspell.settings": "Settings",
    "magicspell.products.title": "Product Management",
    "magicspell.products.desc": "Define SKUs and prices",
    "magicspell.products.create": "Add Product",
    "magicspell.products.empty": "No products",
    "magicspell.products.name": "Product Name",
    "magicspell.products.sku": "SKU",
    "magicspell.products.price": "Price",
    "magicspell.products.status": "Status",
    "magicspell.products.active": "Active",
    "magicspell.products.inactive": "Inactive",
    "magicspell.products.type": "Type",
    "magicspell.products.type.one_time": "One-time",
    "magicspell.products.type.subscription": "Subscription",
    "magicspell.products.stripe_product_id": "Stripe Product ID",
    "magicspell.products.stripe_price_id": "Stripe Price ID",
    "magicspell.entitlements.title": "Entitlements",
    "magicspell.entitlements.desc": "Per-user rights status",
    "magicspell.entitlements.search": "Search by User ID...",
    "magicspell.entitlements.empty": "No entitlements",
    "magicspell.entitlements.user_id": "User ID",
    "magicspell.entitlements.product": "Product",
    "magicspell.entitlements.granted_at": "Granted At",
    "magicspell.entitlements.expires_at": "Expires At",
    "magicspell.entitlements.source": "Source",
    "magicspell.entitlements.revoke": "Revoke",
    "magicspell.entitlements.grant": "Manual Grant",
    "magicspell.entitlements.reconcile": "Reconcile",
    "magicspell.distribution.title": "Distribution Management",
    "magicspell.distribution.desc": "Distribute built artifacts",
    "magicspell.distribution.upload": "Upload File",
    "magicspell.distribution.empty": "No distributions",
    "magicspell.distribution.file": "File",
    "magicspell.distribution.version": "Version",
    "magicspell.distribution.scope": "Scope",
    "magicspell.distribution.downloads": "Downloads",
    "magicspell.distribution.created_at": "Created At",
    "magicspell.audit.title": "Audit Log",
    "magicspell.audit.desc": "Record of all state changes",
    "magicspell.audit.filter": "Filter",
    "magicspell.audit.event": "Event",
    "magicspell.audit.timestamp": "Timestamp",
    "magicspell.audit.actor": "Actor",
    "magicspell.audit.details": "Details",
    "magicspell.ledger.title": "Ledger",
    "magicspell.ledger.desc": "Stripe Event history",
    "magicspell.ledger.event_id": "Event ID",
    "magicspell.ledger.type": "Type",
    "magicspell.ledger.processed_at": "Processed At",
    "magicspell.ledger.idempotency": "Idempotency",
    "magicspell.settings.title": "Settings",
    "magicspell.settings.webhook": "Webhook Settings",
    "magicspell.settings.webhook_url": "Webhook URL",
    "magicspell.settings.webhook_secret": "Webhook Secret",
    "magicspell.settings.api_key": "API Key",
    "magicspell.settings.regenerate": "Regenerate",
    "magicspell.settings.danger_zone": "Danger Zone",
    "magicspell.settings.delete_all": "Delete All Data",
    "magicspell.stats.total_products": "Products",
    "magicspell.stats.active_entitlements": "Active Rights",
    "magicspell.stats.total_downloads": "Total Downloads",
    "magicspell.stats.webhook_events": "Webhook Events",
